...
void ADC_sequence(int *chN, int seqCHnums){

	// Disable ADC 
	// ADC1->CR2 &= ~ADC_CR2_ADON;
	
	ADC1->SQR1 &= ~(0xFUL<<20); 						// reset length of conversions in the regular channel 	
	ADC1->SQR1 |= (seqCHnums-1UL)<<20; 				// conversions in the regular channel conversion sequence
